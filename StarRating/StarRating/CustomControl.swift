...
class CustomControl: UIControl {
    ...
    private let componentDimension: CGFloat = 40.0  // constants cgfloat 40
    private let componentCount = 5 // 5 stars
    private let componentActiveColor = UIColor.black // active star color
    private let componentInactiveColor = UIColor.gray // inactive color
    ...
    override var intrinsicContentSize: CGSize {
        ...
        let componentsSpacing = CGFloat(componentCount + 1) * 8.0 //8 point space between stars
